    ...
    public class WrapPanel : Panel
    {
        ...
        private static void OnOrientationPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
                ...
                (value != Orientation.Vertical))
            {
                ...
                var message = string.Format(
                    ...
                    "Properties.Resources.WrapPanel_OnOrientationPropertyChanged_InvalidValue {0}",
                    value);
        ...
        private static void OnItemHeightOrWidthPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (!double.IsNaN(value) && ((value <= 0.0) || double.IsPositiveInfinity(value)))
            {
                ...
                var message = string.Format(
                    CultureInfo.InvariantCulture,
                    "Properties.Resources.WrapPanel_OnItemHeightOrWidthPropertyChanged_InvalidValue {0}",
                    value);
                throw new ArgumentException(message, "value");
            }
        ...
        /// </param>
        private void ArrangeLine(int lineStart, int lineEnd, double? directDelta, double indirectOffset,
    ...
    internal static class NumericExtensions
    {
        ...
        private struct NanUnion
        {
            ...
            [SuppressMessage("Microsoft.Performance", "CA1823:AvoidUnusedPrivateFields",
                Justification = "It is accessed through the other member of the union")] [FieldOffset(0)] internal
                double FloatingValue;

            /// <summary>
            /// Integer representation of the union.
            /// </summary>
            [FieldOffset(0)] internal ulong IntegerValue;
        }
...
// ReSharper restore CompareOfFloatsByEqualityOperator
            ...
            var a = (Math.Abs(left) + Math.Abs(right) + 10.0) * 2.2204460492503131E-16;
            var b = left - right;
            return (-a < b) && (a > b);
        }
